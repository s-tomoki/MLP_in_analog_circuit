...
\documentclass[11pt,fleqn,book]{jlreq} % Default font size and left-justified equations
...
% chapter を数字のみ "1. "
% \renewcommand\jlreqHeadingLabel{\thechapter} 
% \renewcommand{\thechapter}{\arabic{chapter}.}
\jlreqsetup{chaptertitleformat=\thechapter} % 章番号のみ表示（「第」「章」なし）
% \jlreqsetup{chapter={after-label-text={}}}
